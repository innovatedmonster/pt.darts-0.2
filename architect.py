...
class Architect():
    ...
    def virtual_step(self, trn_X, trn_y, xi, w_optim):
        ...
        """
        # forward & calc loss
        loss = self.net.module.loss(trn_X, trn_y) # L_trn(w)

        # compute gradient
        gradients = torch.autograd.grad(loss, self.net.module.weights())
    ...
    def unrolled_backward(self, trn_X, trn_y, val_X, val_y, xi, w_optim):
        ...
        # calc unrolled loss
        loss = self.v_net.module.loss(val_X, val_y) # L_val(w`)
    ...
    def compute_hessian(self, dw, trn_X, trn_y):
        ...
        with torch.no_grad():
            for p, d in zip(self.net.module.weights(), dw):
                p += eps * d
        loss = self.net.module.loss(trn_X, trn_y)
